...
class collapseNav {
  ...
  init() {
    document.dispatchEvent(new CustomEvent('collapseNav.beforeInit', {
      detail: this
    }));
    this.btns.forEach(btn => this.applyCollapse(btn));
  }
  applyCollapse(btn) {
    const bsCollapse = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Collapse(btn.nextElementSibling, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ drawerNav)
/* harmony export */ });
class drawerNav {
  ...
  init() {
    ...
    document.dispatchEvent(new CustomEvent('drawerNav.beforeInit', {
      detail: this
    }));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ formConfirm)
/* harmony export */ });
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
...
class formConfirm {
  constructor() {
    let selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-plugin="formConfirm"]';
    this.opt = {
      selector
    };
  }
  ...
  onSubmit(e, form) {
    if (!this.modalStatus) {
      ...
      this.modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(modalEL);
      this.modal.show();
...
/* harmony export */ });
/* harmony import */ var _scrollObserver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scrollObserver */ "./src/js/class/scrollObserver.js");

const [d] = [document];
class LazyDisp extends _scrollObserver__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RWD002)
/* harmony export */ });
...
/* harmony import */ var _collapseNav__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./collapseNav */ "./src/js/class/collapseNav.js");
/* harmony import */ var _drawerNav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drawerNav */ "./src/js/class/drawerNav.js");
/* harmony import */ var _formConfirm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./formConfirm */ "./src/js/class/formConfirm.js");
/* harmony import */ var _lazydisp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lazydisp */ "./src/js/class/lazydisp.js");
/* harmony import */ var _scrollDir__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scrollDir */ "./src/js/class/scrollDir.js");
/* harmony import */ var _subNav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./subNav */ "./src/js/class/subNav.js");
/* harmony import */ var _extended_class_FirstViewEndObserver__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../extended_class/FirstViewEndObserver */ "./src/js/extended_class/FirstViewEndObserver.js");
...
class RWD002 {
  constructor(opt) {
    ...
    // サブナビ登録用クラスのインスタンス化
    this.Subnav = new _subNav__WEBPACK_IMPORTED_MODULE_7__["default"](this.opt);

    // スクロール方向を判定するインスタンス
    this.ScrollDir = new _scrollDir__WEBPACK_IMPORTED_MODULE_6__["default"]();

    // drawerNavインスタンス
    this.drawerNav = new _drawerNav__WEBPACK_IMPORTED_MODULE_3__["default"](this.opt.drawerNav);

    // コメントフォーム確認インスタンス
    this.formConfirm = new _formConfirm__WEBPACK_IMPORTED_MODULE_4__["default"](this.opt.formConfirm);
  }
  init() {
    // イベント発火
    d.dispatchEvent(new CustomEvent('rwd002.beforeInit', {
      detail: this
    }));
  ...
  domReady() {
    // イベント発火
    d.dispatchEvent(new CustomEvent('rwd002.beforeDomready', {
      detail: this
    }));
    ...
    // LazyDisp開始
    this.LazyDisp = new _lazydisp__WEBPACK_IMPORTED_MODULE_5__["default"](this.opt.lazydisp);

    // collapseNav開始
    this.collapseNav = new _collapseNav__WEBPACK_IMPORTED_MODULE_2__["default"](this.opt.collapse);
    ...
    // lightbox
    $(d).on('click', 'a[rel="lightbox"]', (lity__WEBPACK_IMPORTED_MODULE_0___default()));
  ...
  windowLoad() {
    // イベント発火
    d.dispatchEvent(new CustomEvent('rwd002.beforeWindowload', {
      detail: this
    }));
  ...
  zip2addr() {
    ...
    const getAddr = btn => {
      ...
      fetch(apiurl.href).then(res => res.json()).then(res => {
        ...
        // イベント発火
        d.dispatchEvent(new CustomEvent('rwd002.zip2addr', {
          detail: {
            btn,
            res
          }
  ...
  pagetop() {
    if (!mq.matches) {
      ...
      new _extended_class_FirstViewEndObserver__WEBPACK_IMPORTED_MODULE_8__["default"](pagetop);
    }
  }
}
...
/***/ "./src/js/class/scrollObserver.js":
/*!****************************************!*\
  !*** ./src/js/class/scrollObserver.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class subNav {
   ...
   */
  add() {
    let navSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.opt.gnav;
    let key = arguments.length > 1 ? arguments[1] : undefined;
    let itemlist = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    const addCollapse = (elm, navKey) => {
      if (elm.dataset.collapse.toLowerCase() === 'true') {
        ...
        const btnClass = () => {
          switch (navKey) {
            case this.opt.gnav:
              return `${this.opt.subnavClass}__tgl`;
            case this.opt.fnav:
              return `${this.opt.footerSubnavClass}__tgl`;
          }
        };
    ...
    const addItem = (elm, navKey) => {
      ...
      switch (navKey) {
        case this.opt.gnav:
          outerHtml = this.outerTemplate(innerHtml);
          break;
        case this.opt.fnav:
          outerHtml = this.footerOuterTemplate(innerHtml);
          break;
      }
...
class Utility {
  ...
  init() {
     ...
     * 文字数制限(プロトタイプ拡張)
     */
    String.prototype.str_truncate = function (figure) {
...
/***/ "./src/js/extended_class/FirstViewEndObserver.js":
/*!*******************************************************!*\
  !*** ./src/js/extended_class/FirstViewEndObserver.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _class_scrollObserver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../class/scrollObserver */ "./src/js/class/scrollObserver.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");

const [d] = [document];
class FirstViewEndObserver extends _class_scrollObserver__WEBPACK_IMPORTED_MODULE_0__["default"] {
  //newしたときに実行される
  constructor() {
    let elm = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : d.querySelector('.rwd002-pagetop__wrap');
...
/***/ "./src/js/extended_class/customize.js":
/*!********************************************!*\
  !*** ./src/js/extended_class/customize.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _class_rwd002__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../class/rwd002 */ "./src/js/class/rwd002.js");
/* harmony import */ var _drawerNav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./drawerNav */ "./src/js/extended_class/drawerNav.js");
/* harmony import */ var _formConfirm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formConfirm */ "./src/js/extended_class/formConfirm.js");
/* harmony import */ var _subNav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subNav */ "./src/js/extended_class/subNav.js");
/* harmony import */ var _class_lazydisp__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../class/lazydisp */ "./src/js/class/lazydisp.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
const [d] = [document];
class CUSTOMIZE extends _class_rwd002__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(opt) {
    opt = Object.assign({
    ...
    this.drawerNav = new _drawerNav__WEBPACK_IMPORTED_MODULE_1__["default"](this.opt.drawerNav);

    // カスタム用サブナビ登録クラスのインスタンス化
    this.Subnav = new _subNav__WEBPACK_IMPORTED_MODULE_3__["default"](this.opt);

    // コメントフォーム用確認画面モーダルのインスタンス化
    this.formConfirm = new _formConfirm__WEBPACK_IMPORTED_MODULE_2__["default"](this.opt.formConfirm);
    this.customInit();
  }
  customInit() {
    // イベント一覧
    ...
    $(() => {
      ...
      // カレントメニュー
      $('[data-plugin=currentMenu]').currentMenu({
        mode: 0,
        default: 999
      });
      Promise.all([window.load['loadHtml']]).then(() => this.hashscroll());
      Promise.all([window.load['loadHtml']]).then(() => new _class_lazydisp__WEBPACK_IMPORTED_MODULE_4__["default"]('[data-lazydisp]'));
    });
  }
...
/***/ "./src/js/extended_class/drawerNav.js":
/*!********************************************!*\
  !*** ./src/js/extended_class/drawerNav.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ customDrawerNav)
/* harmony export */ });
/* harmony import */ var _class_drawerNav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../class/drawerNav */ "./src/js/class/drawerNav.js");

class customDrawerNav extends _class_drawerNav__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(opt) {
    super(opt);
  }
...
/***/ "./src/js/extended_class/formConfirm.js":
/*!**********************************************!*\
  !*** ./src/js/extended_class/formConfirm.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ customFormConfirm)
/* harmony export */ });
/* harmony import */ var _class_formConfirm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../class/formConfirm */ "./src/js/class/formConfirm.js");

class customFormConfirm extends _class_formConfirm__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(opt) {
    super(opt);
  }
...
/***/ "./src/js/extended_class/subNav.js":
/*!*****************************************!*\
  !*** ./src/js/extended_class/subNav.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ customSubNav)
/* harmony export */ });
/* harmony import */ var _class_subNav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../class/subNav */ "./src/js/class/subNav.js");

class customSubNav extends _class_subNav__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(opt) {
    super(opt);
  }
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _class_utility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class/utility */ "./src/js/class/utility.js");
/* harmony import */ var _extended_class_customize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./extended_class/customize */ "./src/js/extended_class/customize.js");
/* harmony import */ var _module_home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/home */ "./src/js/module/home.js");




// ユーティリティクラスのインスタンス化
const UTIL = new _class_utility__WEBPACK_IMPORTED_MODULE_0__["default"]();

// テンプレートインスタンス化（promise登録）
const TPL = new _extended_class_customize__WEBPACK_IMPORTED_MODULE_1__["default"]();

// URLによる関数の実行
UTIL.loader((request, path) => {
  switch (path) {
    case '/':
      (0,_module_home__WEBPACK_IMPORTED_MODULE_2__["default"])();
      break;
  }
  // switch( request ){}
});
